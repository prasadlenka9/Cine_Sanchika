...
// <div className="min-h-screen p-6 text-gray-800" style={{ background: "linear-gradient(to bottom right, #f0f9ff, #e6f7ff)" }}>
//   <div className="max-w-4xl mx-auto">
...
//     {/* Top Favorites */}
//     <div className="mt-6 text-center font-semibold text-lg text-blue-700">Top Favorites</div>

//     {/* Favorites Grid */}
//     <div className="flex justify-center gap-4 mt-4">
//       {favoriteSlots.map((m, idx) => (
//         <div key={idx} className="w-40 h-60 rounded overflow-hidden bg-white shadow cursor-pointer hover:shadow-lg transition">
//           {m ? (
//             <>
//               <img
//                 src={m.poster || "/default-poster.png"}
...
//         <div className="text-xl font-bold text-blue-800">{user.followers?.length || 0}</div>
//         <div className="text-xs text-gray-600">Followers</div>
//       </div>
//       <div className="text-center cursor-pointer" onClick={openFollowing}>
//         <div className="text-xl font-bold text-blue-800">{user.following?.length || 0}</div>
  ...
  return (
    <div className="min-h-screen p-6 text-gray-800" style={{ background: "linear-gradient(to bottom right, #f0f9ff, #e6f7ff)" }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center gap-4 mt-4">
          {favoriteSlots.map((m, idx) => (
            <div key={idx} className="w-36 h-52 rounded overflow-hidden bg-white shadow cursor-pointer hover:shadow-lg transition relative">
              {m ? (
                <>
                  <img
                    src={m.poster || "/default-poster.png"}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-xl max-w-sm w-full">
              ...
              <ul className="space-y-2 max-h-64 overflow-y-auto">
                {followersList.length === 0 && <li className="text-gray-500">No followers</li>}
                {followersList.map((f, idx) => (
                  <li key={idx} className="p-2 border rounded">{f}</li>
                ))}
              </ul>
            </div>
          </div>
        ...
        {showFollowingModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-xl max-w-sm w-full">
              ...
              <ul className="space-y-2 max-h-64 overflow-y-auto">
                {followingList.length === 0 && <li className="text-gray-500">Not following anyone</li>}
