...
//                 onChange={e => setReviewText(e.target.value)}
//                 placeholder="Write your review..."
//                 className="bg-burgundy-700 rounded-lg p-2 text-black resize-none"
//               />
//               <button
//                 onClick={handleSubmitReview}
//                 className="bg-burgundy-500 text-black font-semibold rounded-lg py-2 px-4 hover:bg-green-300 transition"
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      const res = await fetch("http://localhost:5000/api/reviews", {
        ...
        body: JSON.stringify({ movieId: id, rating, reviewText }), // ✅ match backend
      });
          ...
          {!submitted && isLoggedIn && (
            <div className="flex flex-col gap-2 max-w-md mb-6">
              ...
              <textarea
                ...
                onChange={e => setReviewText(e.target.value)}
                placeholder="Write your review..."
                className="bg-white rounded-lg p-2 text-black resize-none border border-gray-300"
              />
              <button
                onClick={handleSubmitReview}
                className="bg-burgundy-500 text-black font-semibold rounded-lg py-2 px-4 hover:bg-green-300 transition"
